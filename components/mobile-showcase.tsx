...
export function MobileShowcase({ primaryColor = "bg-neutral-800", image1, image2, alt = "Mobile App", scale = 1 }: MobileShowcaseProps) {
    return (
        <div className="flex items-center justify-center w-full h-[20rem] md:h-full min-h-[18rem] relative overflow-hidden group-hover/bento:cursor-pointer p-6">
            {/* Background Glow */}
            ...
            >
                ...
                <motion.div
                    ...
                    className="absolute w-[130px] h-[220px] rounded-[32px] bg-neutral-900 border-4 border-neutral-800 shadow-2xl z-10 group-hover/bento:translate-x-8 group-hover/bento:-translate-y-4 transition-transform duration-500 right-6 top-6"
                >
                ...
                <motion.div
                    ...
                    className="absolute w-[140px] h-[240px] rounded-[36px] bg-black border-[6px] border-neutral-800 shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-20 group-hover/bento:-translate-x-4 group-hover/bento:translate-y-2 transition-transform duration-500 left-6 bottom-6"
                >
