...
export function MobileShowcase({ primaryColor = "bg-neutral-800", image1, image2, alt = "Mobile App", scale = 1 }: MobileShowcaseProps) {
    return (
        <div className="flex items-center justify-center w-full h-[16rem] md:h-full min-h-[10rem] relative overflow-hidden group-hover/bento:cursor-pointer">
            {/* Background Glow */}
            ...
            <div
                className="relative w-[320px] h-[320px] flex items-center justify-center flex-shrink-0 origin-center transition-transform duration-500 max-md:[--current-scale:var(--mobile-scale)] md:[--current-scale:var(--desktop-scale)]"
                style={{
                    '--desktop-scale': scale,
                    '--mobile-scale': 0.85,
            ...
            >
                ...
                <motion.div
                    initial={{ opacity: 0, y: 0, x: 20, rotate: 6 }}
